...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#020202] pt-40 pb-20 px-8 border-t border-white/[0.03] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-8 cursor-pointer group" onClick={() => scrollTo('home')}>
            ...
            <p className="text-4xl font-serif italic text-white/70 leading-tight pr-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-12 border-t border-white/[0.03] gap-8">
          <div className="flex items-center gap-6">
            <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-white/30">Civic Hall Architecture © 2026</span>
            <div className="h-4 w-[1px] bg-white/10 hidden md:block" />
            <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-white/30">Built for the public domain</span>
          </div>
          
          <div className="flex items-center gap-12 text-[10px] uppercase tracking-[0.4em] font-bold text-white/50">
